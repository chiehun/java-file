...
<body>
	...
	<div data-role="page">
		...
		<div data-role="content">
			...
			<h3>예약</h3>
				<form action="HairshopServlet?command=cus_res_insert" method="post">
					
					<label><b>예약날짜 :</b></label>
					<input type="text" name="rsv_date" id="rev_date" />
					
					<label><b>예약시간 :</b></label>
					<input type="text" name="rsv_time" id="rev_time" />
					...
					<br /><br />
					<input type="id" name="id" value="${sessionScope.loginUser.id}">
