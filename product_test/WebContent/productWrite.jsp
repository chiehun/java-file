...
<head>
<meta charset=UTF-8>
<title>상품 등록 화면 : productWrite.jsp</title>
<ilnk rel="stylesheet" type="text/css" href="css/shopping.css"> <script
	type="text/javascript" src="script/product.js"></script>
</head>
<body>
	<div id="wrap" align="center">
		<form method="post" enctype="multipart/form-data" name="frm">
			<table>
				...
				<tr>
					<th>가격</th>
					<td><input type="text" name="price" size="80"
